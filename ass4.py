...
# create train/test
x_train, x_test, y_a2_train, y_a2_test = train_test_split(x, y_a2,test_size=0.10, random_state=1)
x_train, x_val, y_a2_train, y_a2_val = train_test_split(x_train, y_a2_train,test_size=0.25, random_state=1)
...
model.fit(x_train, y_a2_train, validation_data=(x_val, y_a2_val),callbacks=[monitor], verbose=2,epochs=1000)
